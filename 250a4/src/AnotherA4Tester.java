 ...
 *
 * @author Zhangyuan Nie, with modifications by Mike Gao and Jacob Tian
 * @version 1g
 */
public class AnotherA4Tester {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("Your result is: " + (ans.equals(out) ? "\u001B[34m" + "Correct" : "\u001B[31m" + "Incorrect"));
        System.out.println(all.size() != out.size() ? "\u001B[31m" + "BUT your amount of entries is not correct, Check for duplicates and/or missing entries in CrawlAndIndex()" : "\u001B[0m" + "==========================================");

        System.out.println("== Checking if no result, return empty ArrayList ==");
        try {
            ArrayList a = search.getResults("adsf");
            System.out.println("\u001B[34m" + "You're fine here");
        }
        catch (NullPointerException e){
            System.out.println("\u001B[31m" + "You need to return an empty arraylist!");
        }
        System.out.println("\u001B[0m" + "==========================================");

        System.out.println("== Did you convert every word into lower case? ==");
        ArrayList<String> out2 = search.getResults("the");
        ArrayList<String> out3 = search.getResults("The");
        System.out.println("Search Result for " + "the" +" :" +out2);
        System.out.println("Search Result for " + "The" +" :" +out3);
        if (out2 == null) {
            System.out.println("We have some major problem here, you might need to check your crawlandIndex() and getResult()");
        }
        if (out3 == null) {
            System.out.println("\u001B[31m" + "Remember to do query.toLowerCase() in getResult()!!!");
        }
        System.out.println("\u001B[0m" + "Your result is: " + (out2.equals(out3) ? "\u001B[34m" + "Correct" : "\u001B[31m" + "Incorrect"));
        System.out.println("\u001B[0m" + "==========================================");
